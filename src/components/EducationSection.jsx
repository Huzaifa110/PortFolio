                        ...
                        <div className="flex mb-8 items-start" key={education.number}>
                            ...
                            <div className="flex-1">
                                ...
                                <span className="flex items-center">
                                    ...
                                    <p className="text-gray-700 text-lg sm:text-xl">{education.institution}</p>
                                </span>
                                <span className="flex items-center">
                                    <FaCalendar className="text-blue-500 mx-1 text-lg sm:text-xl" />
                                    <p className="text-gray-700 text-md sm:text-lg">{education.dates}</p>
                                </span>
